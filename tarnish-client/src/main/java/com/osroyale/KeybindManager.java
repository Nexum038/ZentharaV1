...
public final class KeybindManager {
	...
	// Button ID that triggers player.bank.open() on the server
	private static final int BANK_BUTTON_ID = -9217;
	...
	/** Stuurt een hotkey als button packet via opcode 185. */
	public void sendHotkey(int hotkeyId) {
		Client.instance.outgoing.writeOpcode(185);
		Client.instance.outgoing.writeShort(hotkeyId);
	}

	/** Opens the bank via hotkey packet. */
	public void openBank() {
		sendHotkey(-9217);
	}

	/** Home teleport via hotkey packet. */
	public void homeTeleport() {
		sendHotkey(-9216);
	}

	/** Teleport menu via hotkey packet. */
