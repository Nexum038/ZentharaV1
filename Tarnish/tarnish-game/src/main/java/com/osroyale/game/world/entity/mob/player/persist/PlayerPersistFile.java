...
public final class PlayerPersistFile implements PlayerPersistable {
    ...
    private static final PlayerJSONProperty[] PROPERTIES = {
            ...
            new PlayerJSONProperty("perk-combat-points-earned") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.combatPointsEarned = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.combatPointsEarned;
                }
            },

            new PlayerJSONProperty("perk-combat-points") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.combatPoints = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.combatPoints;
                }
            },

            new PlayerJSONProperty("perk-combat-levels") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.combatPerkLevels = gson().fromJson(property, int[].class);
                }
                @Override
                Object write(Player player) {
                    return player.perk.combatPerkLevels;
                }
            },

            new PlayerJSONProperty("perk-combat-active") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.activeCombatPerk = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.activeCombatPerk;
                }
            },
            new PlayerJSONProperty("perk-skilling-points-earned") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.skillingPointsEarned = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.skillingPointsEarned;
                }
            },
            new PlayerJSONProperty("perk-skilling-points") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.skillingPoints = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.skillingPoints;
                }
            },
            new PlayerJSONProperty("perk-skilling-levels") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.skillingPerkLevels = gson().fromJson(property, int[].class);
                }
                @Override
                Object write(Player player) {
                    return player.perk.skillingPerkLevels;
                }
            },
            new PlayerJSONProperty("perk-skilling-active") {
                @Override
                void read(Player player, JsonElement property) {
                    player.perk.activeSkillingPerk = property.getAsInt();
                }
                @Override
                Object write(Player player) {
                    return player.perk.activeSkillingPerk;
                }
            },

            new PlayerJSONProperty("drop-rate-boost") {
                @Override
                void read(Player player, JsonElement property) {
                    player.dropRateBoost = property.getAsDouble();
                }
                @Override
                Object write(Player player) {
                    return player.dropRateBoost;
                }
            }
    };
