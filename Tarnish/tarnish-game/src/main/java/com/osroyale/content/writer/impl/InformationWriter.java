...
public class InformationWriter extends InterfaceWriter {
    ...
    private String[] text = {
            ...
            "  -Drop Rate: <col=FFB83F>" + PlayerRight.getDropRateBonus(player) + "%",
    ...
    private int[][] font = {
            {29451, 3},  // Game Information:
            {29455, 3},  // Events:
            {29459, 3},  // Player Information:
            {29464, 3},  // Player Statistics:
            {29473, 3}   // Slayer Information:
    };
