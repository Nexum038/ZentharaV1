...
public enum PetData {
    ...
    GRAARDOR("General graardor", 12650, 6644, 5.0) {
        @Override
        public void dialogue(DialogueFactory factory) {
    ...
    ZULRAH_BLUE("Snakeling", 12940, 2129, 5000) {
        @Override
        public void dialogue(DialogueFactory factory) {
            factory.sendPlayerChat("Hey little snake!");
    ...
    /** The drop rate bonus this pet provides when following the player. */
    private final double dropRateBonus;
    ...
    /** Constructs a new <code>PetData<code> with drop rate bonus. */
    PetData(String name, int item, int npc, double dropRateBonus) {
        this.item = item;
        this.npc = npc;
        this.name = name;
    ...
    /** Gets the drop rate bonus this pet provides. */
